        ...
        <div className="base-paginas-internas">
            ...
            <p>
                ...
                <Image imagen={MinecraftPicnic1} width={160} height={160} foto="260" margin="10" espaciado="2" minWidth={true}>
                    Ese<O ff="mesa-minecraft">la de la contraseña</O> mundo era uno en el cual no me querías dejar entrar ya que no querías que viera lo que había, aunque <O ff="mesa-minecraft">y tambien en la pista</O>lo único que había era todo lo increíble que habías construido allí.
                ...
                <div className="column" style={{marginLeft: "10px", marginRight: "10px"}}>
                    ...
                    <Image imagen={MinecraftCasa2} width={160} height={160} foto="290" margin="10" espaciado="2" minWidth={true}>
                        las más importantes ya que aquí<O ff="mesa-minecraft">sera dificil u obvio</O> pudimos jugar un mundo ambos empezando de cero, conviviendo juntos y<O ff="mesa-minecraft">quien sabe</O> teniendo mucha libertad. <br/>
