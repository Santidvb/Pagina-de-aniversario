        ...
        <div className="base-paginas-internas">
            ...
            <p>
                ...
                <Image imagen={MinecraftPicnic1} width={160} height={160} foto="260" margin="10" espaciado="2" minWidth={true}>
                    Ese<O ff="mesa-minecraft">la de la contrasena</O> mundo era uno en el cual no me querías dejar entrar ya que no querías que viera lo que había, aunque <O ff="mesa-minecraft">y tambien en la pista</O>lo único que había era todo lo increíble que habías construido allí.
